...
exports.DishesGalleryQueriesService = void 0;
const mysql2_1 = __importDefault(require("mysql2"));
const __1 = require("../..");
const apiResponses_1 = require("../common/apiResponses");
const constants_1 = require("./constants");
class DishesGalleryQueriesService {
}
exports.DishesGalleryQueriesService = DishesGalleryQueriesService;
_a = DishesGalleryQueriesService;
DishesGalleryQueriesService.getAllDishesGallery = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = `SELECT * FROM ${constants_1.DISHES_GALLERY_TABLE.name} ORDER BY ${constants_1.DISHES_GALLERY_TABLE.columns.position} ASC`;
...
DishesGalleryQueriesService.getGalleryDishById = (dishId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = mysql2_1.default.format(`SELECT * FROM ${constants_1.DISHES_GALLERY_TABLE.name} WHERE ${constants_1.DISHES_GALLERY_TABLE.columns.id} = ?`, [dishId]);
        const [rows] = yield __1.dbConnexion.execute(query);
        if (rows.length > 0) {
        }
...
DishesGalleryQueriesService.getGalleryDishByTitle = (dishTitle) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = mysql2_1.default.format(`SELECT * FROM ${constants_1.DISHES_GALLERY_TABLE.name} WHERE ${constants_1.DISHES_GALLERY_TABLE.columns.title} = ?`, [dishTitle]);
        const [rows] = yield __1.dbConnexion.execute(query);
        if (rows.length > 0) {
        }
...
DishesGalleryQueriesService.getGalleryDishByImage = (dishImage) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = mysql2_1.default.format(`SELECT * FROM ${constants_1.DISHES_GALLERY_TABLE.name} WHERE ${constants_1.DISHES_GALLERY_TABLE.columns.image} = ?`, [dishImage]);
        const [rows] = yield __1.dbConnexion.execute(query);
        if (rows.length > 0) {
        }
...
DishesGalleryQueriesService.getGalleryDishDuplicate = (dish) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = mysql2_1.default.format(`SELECT * FROM ${constants_1.DISHES_GALLERY_TABLE.name} WHERE (${constants_1.DISHES_GALLERY_TABLE.columns.image} = ? OR ${constants_1.DISHES_GALLERY_TABLE.columns.title} = ?) `, [dish.image, dish.title]);
        if (dish.id) {
            query += mysql2_1.default.format(` AND ${constants_1.DISHES_GALLERY_TABLE.columns.id} != ?`, [
                dish.id,
            ]);
        }
        const [rows] = yield __1.dbConnexion.execute(query);
